  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      ...
      <CommonOnboardingHeader
        ...
        description="Đây là cách đồng nghiệp sẽ nhìn thấy bạn trong không gian làm việc THM."
      />
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="text-13">{userAvatar ? "Đổi ảnh đại diện" : "Tải ảnh đại diện"}</span>
        </button>
      </div>
